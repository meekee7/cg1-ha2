/*
	...
	06.11.2006 andy nealen
	modified for clip-space viewing in the context
	of 'computer graphics 1' (cg1)
	winter term 2006/2007, assignment 2
...
world_display(void)
{
	...
	// compute inverse of current projection matrix
	invert(projection, p_inverse);
	// apply inverse projection transformation to canonical view-volume
	// which gives us the actual viewing frustum
	glMultMatrixd(p_inverse);

	/* draw the canonical view-volume */
	// back clip plane
...
// NOTE: screen_reshape sets the current projection and 
// modelview matrix in 'projection[16]' and 'modelview[16]'
void
...
main(int argc, char** argv)
{
	...
	window = glutCreateWindow("Projection Assignment cg1_ws03/04");
